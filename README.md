...
**[⬇ Download for Windows](https://github.com/LorenzoDainelli/local-ai-frame-classifier-rilasci/releases/download/v2.0.0-beta.13/local-ai-frame-classifier-2.0.0-beta.13.exe)** · version 2.0.0-beta.13 · 38 MB ·
...
1. **[Download the installer](https://github.com/LorenzoDainelli/local-ai-frame-classifier-rilasci/releases/download/v2.0.0-beta.13/local-ai-frame-classifier-2.0.0-beta.13.exe)** (38 MB).
