...
1. Download the latest installer: **[local-ai-frame-classifier-2.0.0-beta.13.exe](https://github.com/LorenzoDainelli/local-ai-frame-classifier-rilasci/releases/download/v2.0.0-beta.13/local-ai-frame-classifier-2.0.0-beta.13.exe)**.
