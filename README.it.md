...
**[⬇ Scarica per Windows](https://github.com/LorenzoDainelli/local-ai-frame-classifier-rilasci/releases/download/v2.0.0-beta.14/local-ai-frame-classifier-2.0.0-beta.14.exe)** · versione 2.0.0-beta.14 · 38 MB ·
...
1. **[Scarica l'installatore](https://github.com/LorenzoDainelli/local-ai-frame-classifier-rilasci/releases/download/v2.0.0-beta.14/local-ai-frame-classifier-2.0.0-beta.14.exe)** (38 MB).
